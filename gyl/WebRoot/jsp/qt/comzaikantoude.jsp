...
<HTML><HEAD><TITLE>美好前程招聘———企业看投来的简历</TITLE>
...
<%
 ...
 %>
<DIV align=center>【<a href="<%=request.getContextPath() %>/mianshitongzhi?actionType=zhuanfayie&resume_name=<%=comzaikantoudemap.get("resume_name") %>&user_info_id=<%=comzaikantoudemap.get("user_info_id") %>" >发面试通知</a>】
                ...
                <TD vAlign=top width=400>
                  ...
                  border=0>
                    ...
                    <TR>
                      ...
                      <TD width=135><SPAN class=t><%=(comzaikantoudemap.get("work_year")).equals("0")?"无":(comzaikantoudemap.get("work_year"))%></SPAN></TD>
                      ...
                      <TD>
                        ...
                        width="100%" border=0>
                          ...
                          <TR>
                            ...
                            <TD vAlign=top><span class="t"><%=comzaikantoudemap.get("hope_money") %>(人民币)/月</span></TD>
                          </TR></TABLE></TD></TR></TABLE></DIV></TD></TR></TABLE></TD></TR>
        <TR>
          <TD>
                    ...
                    <TR>
                      <TD>
                        ...
                        width="100%" border=0>
                          ...
                          【<a href='<%=request.getContextPath() %>/mianshitongzhi?actionType=zhuanfayie&resume_name=<%=comzaikantoudemap.get("resume_name") %>&user_info_id=<%=comzaikantoudemap.get("user_info_id") %>' >发面试通知</a>】
                          </DIV></BODY></HTML>
