...
<HTML><HEAD><TITLE>创建企业招聘信息</TITLE>
...
<TABLE id=table2 cellSpacing=0 cellPadding=0 width="100%" border=0>
  ...
  <TR>
    <TD class=tdtit height=30><B>创建企业招聘信息--招聘信息</B>    </TD>
  </TR>
...
border=1>
  ...
  <TR>
    ...
    <TD class=tdiright height=38><TABLE  cellSpacing=0 cellPadding=0 width="100%"  border=0>
        <TR>
          <TD class=tdtsin><INPUT style="WIDTH: 158px; HEIGHT: 21px"  name=want_age>岁&nbsp;&nbsp;&nbsp;例（25-30）</TD>
  ...
  <TR>
    ...
    <TD class=tdiright height=38>
         <TABLE  cellSpacing=0 cellPadding=0 width="100%"  border=0>
  <TR>
   <TD class=tdtsin><INPUT style="WIDTH: 158px; HEIGHT: 21px"  name=want_amount value="若干">人&nbsp;&nbsp;&nbsp;（如不填写默认为若干）</TD>
  ...
  <TR>
   <TD class=tdtsin><label>
     <input type="radio" name="want_sex" value=男>男&nbsp;&nbsp;<input type="radio" name="want_sex" value=女>女&nbsp;&nbsp;<input type="radio" name="want_sex"  value=不限 CHECKED>不限
   </label></TD>
