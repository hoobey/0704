...
Map map=(Map)list.get(0);
 ...
 <INPUT TYPE="hidden" NAME="admin_id" value="<%=(String)map.get("admin_id")%>">
      ...
      <tr>
        <td class="subtitle navi_bar" align="center">修改管理员</td>
      </tr>
    </table> 
<br>
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="menu_table" id="table13">
	<tr align="center">     
			<td width="100%"  class="page td_search">修改管理员信息</td> 
    </tr>
</table>
	...
	<tr>
      ...
      <td class="page td_title" ></td>
      <td class="page td_title" width="100">新登录密码</td>
      <td class="page td_list" width="100">
...
<!--
	function  baocun()
	{
	 ...
	 {
	 div3.innerHTML="<span style='color:red'>新登录密码不能为空<span>";
	 return;
	 }
	 else
	 {
