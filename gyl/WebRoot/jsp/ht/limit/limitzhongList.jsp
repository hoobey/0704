...
<form name="thisfrom" method="get" action="" >
 <input type="hidden" name="actionType" value="">
  ...
  <br>
    ...
    <tr>
      <td class="align_right"><input name="new_button5" type="button" class="input_text" onClick="add()" value="添加高层权限">
      <input name="new_button5" type="button" class="input_text" onClick="del()" value="删除高层权限">
      </td>
    </tr>
  </table>
   <table class="table_style" cellspacing="1" cellpadding="4" width="100%" id="table2" >
	...
	<td class="page td_title" width="50"><input name="selectAll" type="checkbox" title='全选/取消' onclick="checkAll()">全选</td>
	  ...
	  <td class="page td_title">高层权限名</td>
	   <td class="page td_title">是否有链接</td>
	    <td class="page td_title">父id</td>
	  	<td class="page td_title">看低层权限</td>  
	...
	<td class="page td_list" >
			 <a href="htlimit?actionType=query1&limit_id=<%=(String)map.get("limit_id")%>">看此权限的低层权限</a>
	 </td>
        <td class="page td_list" >
			 <a href="htlimit?actionType=updatePage&limit_id=<%=(String)map.get("limit_id")%>">修改高层权限</a>
	 </td>
    </tr>
    <tr>
	<%
