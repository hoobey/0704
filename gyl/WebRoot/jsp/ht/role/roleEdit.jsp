...
Map map=(Map)list.get(0);
 ...
 <INPUT TYPE="hidden" NAME="role_id" value="<%=(String)map.get("role_id")%>">
      ...
      <tr>
        <td class="subtitle navi_bar" align="center">修改角色</td>
      </tr>
    </table>
<br>
<table width="100%" border="1" cellpadding="0" cellspacing="0" class="menu_table" id="table13">
	<tr align="center">     
			<td width="100%"  class="page td_search">角色信息修改</td> 
    </tr>
</table>
	...
	<tr>
      ...
      <td class="page td_list" width="30">
             <input name="role_name" type="text" class="input_area" value="<%=map.get("role_name") %>" >
	  </td>
      <td class="page td_title"></td>
      <td class="page td_title"></td>
    </tr>
